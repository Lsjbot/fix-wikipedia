...
class MyBot : Bot
{
    ...
    public static void Main()
	{
        ...
        site.defaultEditComment = "Bot fixing articles";
        ...
        do
        {
            ...
            //foreach (Page p in pl1)
            //    pl.Add(p);
            pl.FillFromCategory("Georgia (nasod) paghimo ni bot");
            ...
            //pl.FillFromLinksToPage("Sofija (huvudstaden)");
            ...
            //replacedict.Add(@"]]. Ang bug-os nga algoritmo anaa [https://sv.wikipedia.org/wiki/Wikipedia:Projekt_DotNetWikiBot_Framework/Lsjbot/Make-Geonames dinhi].}}", "]]. ");
            //replacedict.Add("Åboland-Turunmaa", "Åboland");
            //replacedict.Add("huvudstaden [[Sofija (huvudstaden)|Sofija]]", "huvudstaden [[Sofia]]");
            replacedict.Add("[[Georgia (nasod)]]", "[[Heyorhiya]]");
            replacedict.Add("{{flag|Georgia (nasod)}}", "{{flag|Heyorhiya}}");
            replacedict.Add("sa Georgia (nasod).", "sa Heyorhiya.");
            ...
            foreach (Page p in pl)
            {
                ...
                //special for adding iw to copied pages:
