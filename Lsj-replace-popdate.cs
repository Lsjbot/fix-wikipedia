...
class MyBot : Bot
{
    ...
    public static void Main()
	{
        ...
        do
        {
            ...
            //foreach (Page p in pl1)
            //    pl.Add(p);
            pl.FillFromCategory("Robotskapade artiklar 2015-11");
            ...
            foreach (Page p in pl)
            {
                ...
                //}
                List<string> pn = p.GetTemplateParameter("geobox", "population_note");
                foreach (string pnn in pn)
                {
                    if (pnn.Contains("från") && pnn.Contains("wiki"))
                        p.SetTemplateParameter("geobox", "population_date", "", true);
                }
